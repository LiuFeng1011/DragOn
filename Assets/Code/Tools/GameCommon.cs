...
public class GameCommon  {
    ...
    public static Vector3 ScreenPositionToWorld(Camera camera,Vector3 pos)
    {
        Vector3 wp = camera.ScreenToWorldPoint(new Vector3(pos.x, pos.y, pos.z - camera.transform.position.z));
        return wp;
    }
